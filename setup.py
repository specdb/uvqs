...
#
setup_keywords['name'] = 'uvqs'
setup_keywords['description'] = 'UVQS Spectra Database'
setup_keywords['author'] = 'Prochaska, Monroe, et al.'
setup_keywords['author_email'] = 'xavier@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/specdb/uvqs'
#
